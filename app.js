...
function finishAuction(message="Lelang selesai — pemenang ditentukan"){running=false;clearInterval(interval);auctionFinished=true;inDraw=false;$("timerNote").textContent=message;render();toast("🏆 "+message)}
...
function setRunning(v){
  ...
  running=v;clearInterval(interval);
  if(v){
...
function setupSocket(){
  ...
  socket.on("connect",()=>updateConnectionLog("server terhubung ✓","ok"));
